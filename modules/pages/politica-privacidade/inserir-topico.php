...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4" style="flex-direction: column; align-items: flex-start !important;">
            <h1 class="h1 mb-0 text-gray-800">Política de Privacidade e Protecção de Dados - Inserir Tópico</h1>
          </div>
  ...
  ?>
  <script src="js/inserir-topico.js"></script>
