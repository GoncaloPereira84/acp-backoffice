                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div id="formacoes" class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div id="formacoesList" class="row">
                                    </div>

                                    <div class="formacaoInfo row" style="display:none;">
                                        <div class="col-lg-12">
                                            <h4 style="margin-top: 30px;">Informação da Formação</h4>
                                        </div>
                                    </div>
                                    <div id="formacaoInfo" class="row" style="display:none;">
                                        <div class="col-lg-12" style="display: flex;">
                                    ...
                                    <div class="row" style="justify-content: flex-end;">
                                        <div class="col-auto">
                                            <a id="deleteFormacao" class="btn btn-danger btn-icon-split float-right">
