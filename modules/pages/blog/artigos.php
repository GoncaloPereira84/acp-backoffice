            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="flex-direction: column; align-items: flex-start !important;">
                        <h1 class="h1 mb-0 text-gray-800">Blog - Artigos</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div id="blog-posts" class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div id="postsList" class="row" style="max-height: 500px; overflow: auto;">
                                    </div>

                                    <div class="row postInfo" style="display:none;">
                                        <div class="col-lg-12">
                                            <h4 style="margin-top: 30px;">Informação do Post</h4>
                                        </div>
                                    </div>
                                    <div id="postInfo" class="row" style="display:none;">
                                    ...
                                    <div class="row" style="justify-content: flex-end;">
                                        <div class="col-auto">
                                            <a id="deletePost" class="btn btn-danger btn-icon-split float-right">
